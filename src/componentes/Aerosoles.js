        ...
        <div id="container-principal" className="container">
            ...
            <div id="container-instrucciones" className="instrucciones">   
                ...
                <div className="instructions-content">
                    <p><strong id="aling-izq">Paso 1:</strong> <img src={destapar} alt="destapar" className="instruction-icon2"/>Retire la tapa de la boquilla del aerosol.</p>
                    ...
                    <p><strong id="aling-izq">Paso 4:</strong> <img src={mascara} alt="mascara" className="instruction-icon" /> Coloque la máscara de la aerocámara cubriendo nariz y boca, sellando con la cara. ⚠️ El niño debe estar despierto, sin llorar y sin chupete.</p>

                    <p><strong id="aling-izq">Paso 5:</strong> <img src={inhaladorApretado} alt="apretar inhalador" className="instruction-icon" /> <strong id="azul">Apriete el aerosol 1 sola vez</strong> y <strong>Cuente hasta 10 sin retirar la máscara de la cara</strong> mientras el niño respira lento y profundo por la boca.</p>

                    <p><strong id="aling-izq">Paso 6:</strong> <img src={contento} alt="contento" className="instruction-icon" />Retire la máscara de la cara y el aerosol de la aerocámara.</p>
                    <br/>
                    ...
                    <p><strong id="aling-izq">Paso 9:</strong> 🚰💧 Enguajar la boca del niño con agua potable.⚠️🚫 <strong>NO</strong> tragar. </p>
                    <br/>

                    <p><strong id="aling-izq">Paso 10:</strong> 🚫👶 Guardar el aerosol y la aerocámara en un lugar fresco y seco y alejado del alcance de los niños.</p>
                    <br/>
                    ...
                    <br/>
                    <span id="manito">🚫🧼 <strong>NO</strong><strong id="azul"> refregar ni secar con paño.</strong> </span>
                    <br/>
